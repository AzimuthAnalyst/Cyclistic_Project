...
-- Breaking out started_at and ended_at into individual columns and distrubute them in new different columns
...
from ride_length 
where trip_duration > 0 and trip_duration < 1440 
group by date_month,member_casual, rideable_type
...
from hour_count_CTE 
where trip_duration > 0 and trip_duration < 1440 
group by hour_, day_of_week,member_casual,
rideable_type
...
member_casual, 
count(end_station_name) as End_station_rides
from [master].[dbo].[202201-divvy-tripdata]
group by member_casual, end_station_name
order by End_station_rides desc 
...
end_lng
from [master].[dbo].[202201-divvy-tripdata]
where end_station_name like '%theater on%'
